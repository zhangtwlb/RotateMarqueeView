...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btStop, bt_control_continue, bt_control_add, bt_control_blink, bt_control_open_translation;
    private EditText ed_text;
    private Spinner bt_control_color, bt_control_size, bt_control_speed, bt_control_from_translation, bt_control_alpha, bt_control_count, bt_control_repeat_count, bt_control_space, bt_control_location;
    ...
    private void initClickListenser() {
        ...
        bt_control_blink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mV3.setCurrentType(MarqueeView.TYPE_BLINK);
            }
        });
        bt_control_open_translation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mV3.setCurrentType(MarqueeView.TYPE_DISPLACEMENT);
            }
        });
